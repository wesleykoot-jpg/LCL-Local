...
function parseDate(dateStr: string, referenceDate: Date = new Date()): string | null {
  ...
  const weekdays = ['maandag', 'dinsdag', 'woensdag', 'donderdag', 'vrijdag', 'zaterdag', 'zondag', 'ma', 'di', 'wo', 'do', 'vr', 'za', 'zo'];
