...
export const MissionModeDrawer = memo(function MissionModeDrawer({
  ...
  const eventsForMap = data?.events.map(e => ({
    ...e,
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 bg-background rounded-t-[20px] shadow-2xl z-50 flex flex-col overflow-hidden border-t"
          >
            {/* Drag Handle */}
            <div className="flex justify-center pt-3 pb-1 flex-shrink-0 touch-pan-y">
              <div className="w-12 h-1.5 bg-muted rounded-full" />
            </div>

            {/* Header */}
            <div className="px-5 pb-4 pt-1 flex items-center justify-between flex-shrink-0 border-b">
              <div>
