  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 p-6 max-w-md mx-auto w-full">
        ...
        {/* Email/Password Form */}
        <form onSubmit={handleEmailSignIn} className="space-y-0 mb-4">
        ...
        <p className="text-[12px] text-muted-foreground mb-4">
          We'll email you to confirm your account. Standard message and data rates apply.
        </p>
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-black hover:bg-gray-900 text-white font-semibold py-4 px-6 rounded-xl flex items-center justify-center gap-3 transition-all disabled:opacity-50 disabled:cursor-not-allowed border border-black text-[15px] min-h-[52px]"
          >
