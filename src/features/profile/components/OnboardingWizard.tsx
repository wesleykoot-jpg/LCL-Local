...
import {
  useGeolocation,
  type UserLocation,
} from "@/features/location/hooks/useGeolocation";
import { useLocation } from "@/features/location";
import toast from "react-hot-toast";
import { reverseGeocode } from "@/features/location/utils/geocoding";
...
export function OnboardingWizard({
  ...
  const { getCurrentPosition, requestPermission, permissionState } =
    useGeolocation();
  ...
  const handleUseCurrentLocation = useCallback(async () => {
    ...
    try {
      ...
      if (permissionState === "prompt" || permissionState === "unknown") {
        ...
        if (!granted) {
          toast.error(
            "Please enable location services or type your city manually.",
          );
      ...
      if (!position) {
        toast.error(
          "Unable to get your location. Please type your city manually.",
        );
        setIsGettingLocation(false);
        return;
      }
          ...
          <div className="flex items-center gap-4">
            {step > 1 && (
              ...
              >
                <ChevronRight
                  size={20}
                  className="rotate-180 text-foreground"
                />
              </button>
            )}
            <div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 mb-2">
                        <span
                          className={cn("w-3 h-3 rounded-full", cat.dotClass)}
                        />
                      </div>
                ...
                <div className="w-full max-w-md space-y-4">
                    ...
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[13px] text-muted-foreground leading-relaxed">
                          I understand that LCL does not tolerate objectionable
                          content, harassment, or illegal activity. I agree to
                          follow community guidelines and acknowledge that
                  ...
                  <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <div>
                        <h4 className="font-semibold text-foreground text-[14px] mb-1">
                          Community Safety
                        </h4>
                        <p className="text-[13px] text-muted-foreground">
                          Objectionable content including hate speech,
                          harassment, violence, or illegal activity will result
                          in immediate action. We maintain a safe, inclusive
            ...
            {step === 4 && (
              ...
              >
                ...
                <p className="text-muted-foreground text-[15px] max-w-xs mb-6">
                  Your personalized feed is ready with {selectedCategories.size}{" "}
                  categories near {zone}
                </p>
                ...
                <div className="max-w-md px-4 py-4 mb-6 bg-primary/5 border border-primary/10 rounded-card">
                  <div className="flex items-start gap-3 mb-2">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-[13px] text-muted-foreground">
                        Your feed will learn from your interests as you explore
                        events. Switch between Family and Social modes anytime
                        to get perfectly tailored recommendations.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  {Array.from(selectedCategories)
                    ...
                    .map((catId) => {
                      ...
                      return (
                        ...
                        >
                          <span
                            className={cn("w-2 h-2 rounded-full", cat.dotClass)}
                          />
                          {cat.label}
                        </span>
                      );
