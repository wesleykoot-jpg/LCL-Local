...
// Canal Boat Ride Event
export const canalBoatRide: EventWithAttendees = {
  id: 'canal-boat-001',
  title: 'Canal Boat Ride: Scenic Canals',
  description: 'Experience the city from the water with a relaxing canal boat tour. See historic bridges, charming houseboats, and picturesque waterways.',
  category: 'outdoors',
  event_type: 'anchor',
  event_date: addDays(5),
  event_time: '14:00',
  venue_name: 'Central Canal Dock',
  location: null,
  status: 'active',
  ...
  created_at: NOW.toISOString(),
  updated_at: NOW.toISOString(),
  source_id: 'scraper-canal-tours',
  event_fingerprint: 'fp-canal-boat-scenic',
  max_attendees: 30,
  parent_event_id: null,
  parent_event: null,
  time_mode: 'fixed',
...
// Morning Market Tour Event
export const morningMarketTour: EventWithAttendees = {
  id: 'market-tour-001',
  title: 'Morning Market Tour',
  description: 'Discover local flavors and fresh produce at the vibrant morning market. Meet local vendors and sample regional specialties.',
  category: 'foodie',
  event_type: 'signal',
  event_date: addDays(3),
  event_time: '08:00',
  venue_name: 'Historic Farmers Market',
  location: null,
  status: 'active',
...
// Street Art Walk Event
export const streetArtWalk: EventWithAttendees = {
  id: 'street-art-001',
  title: 'Street Art Walk: Urban Gallery',
  description: 'Explore the city\'s best street art and murals with a local guide. Learn about the artists and stories behind the vibrant urban canvas.',
  category: 'workshops',
  event_type: 'signal',
  event_date: addDays(6),
  event_time: '16:00',
  venue_name: 'Arts District Meeting Point',
  location: null,
  status: 'active',
  image_url: 'https://images.unsplash.com/photo-1499781350541-7783f6c6a0c8?w=800&q=80',
  match_percentage: 91,
  attendee_count: 11,
  attendees: mockAttendees,
  created_by: 'user-3',
