...
if (!SUPABASE_URL) {
  console.error(
    "[Supabase] Missing VITE_SUPABASE_URL. Copy .env.example to .env and configure.",
  );
}
if (!SUPABASE_PUBLISHABLE_KEY) {
  console.error(
    "[Supabase] Missing VITE_SUPABASE_PUBLISHABLE_KEY. Copy .env.example to .env and configure.",
  );
}
