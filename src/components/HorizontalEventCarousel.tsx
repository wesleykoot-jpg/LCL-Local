  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] rounded-xl overflow-hidden bg-muted mb-2">
        ...
        <button
          onClick={handleSave}
          className="absolute top-2 right-2 w-7 h-7 rounded-full bg-white flex items-center justify-center hover:scale-110 transition-transform shadow-sm"
        >
          <Heart 
            size={14} 
        ...
        {/* Date badge */}
        <div className="absolute bottom-2 left-2 px-2 py-0.5 rounded-md bg-white text-[12px] font-semibold text-foreground shadow-sm">
