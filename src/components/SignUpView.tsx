...
export function SignUpView({ onSwitchToLogin }: SignUpViewProps) {
  ...
  const passwordStrength = (pwd: string) => {
    ...
    if (pwd.length < 10) return { text: 'Good', color: 'text-yellow-400' };
      ...
      <div className="w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-400">Join your local social network</p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-transparent text-zinc-400">Or sign up with email</span>
            </div>
          </div>
